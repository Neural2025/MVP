...
const TeamPage = () => {
  ...
  if (loading) return <div className="min-h-screen flex items-center justify-center">Loading team info...</div>;
  if (error) return (
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-md p-8">
        <h1 className="text-3xl font-bold text-blue-700 mb-4">Team: {team.name}</h1>
        <div className="mb-4">
          <span className="font-semibold">Team Code:</span> <span className="font-mono bg-gray-100 px-2 py-1 rounded">{team.code}</span>
        </div>
