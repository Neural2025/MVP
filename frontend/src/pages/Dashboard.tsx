      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-900">
        <div className="text-center">
          <div className="relative">
            <div className="w-20 h-20 border-4 border-gray-500/30 border-t-gray-500 rounded-full animate-spin mx-auto mb-4"></div>
            <div
              className="absolute inset-0 w-20 h-20 border-4 border-gray-500/30 border-b-gray-500 rounded-full animate-spin mx-auto"
              style={{ animationDirection: "reverse", animationDuration: "1.5s" }}
            ></div>
          </div>
          <h2 className="text-2xl font-bold text-white mb-2 animate-pulse">Loading Dashboard</h2>
          <p className="text-gray-500 animate-pulse">Preparing your analytics...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="container mx-auto py-12">
        ...
        <Tabs defaultValue="overview">
          <TabsList className="mb-4">
            <TabsTrigger value="overview" className="text-white bg-gray-800">Overview</TabsTrigger>
            <TabsTrigger value="analytics" className="text-white bg-gray-800">Analytics</TabsTrigger>
          </TabsList>
          <TabsContent value="overview" className="space-y-8">
            <Card className="bg-gray-900 border border-gray-700">
              <CardHeader>
                <CardTitle className="text-white">Team Metrics Overview</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-gray-800 rounded-lg shadow p-6 flex flex-col items-center">
                    <span className="text-2xl font-bold text-white">{stats.coverage || 0}%</span>
                    <span className="text-gray-400 mt-2">Code Coverage</span>
                  </div>
                  <div className="bg-gray-800 rounded-lg shadow p-6 flex flex-col items-center">
                    <span className="text-2xl font-bold text-white">{stats.bugsFixedByDev || 0}</span>
                    <span className="text-gray-400 mt-2">Bugs Fixed by Developer</span>
                  </div>
                  <div className="bg-gray-800 rounded-lg shadow p-6 flex flex-col items-center">
                    <span className="text-2xl font-bold text-white">{stats.bugsFoundByTester || 0}</span>
                    <span className="text-gray-400 mt-2">Bugs Found by Tester</span>
                  </div>
                  <div className="bg-gray-800 rounded-lg shadow p-6 flex flex-col items-center">
                    <span className="text-2xl font-bold text-white">{stats.totalBugReports || 0}</span>
                    <span className="text-gray-400 mt-2">Total Bug Reports</span>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <TabsContent value="analytics" className="space-y-8">
            <Card className="bg-gray-900 border border-gray-700">
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-gray-800 rounded-lg shadow p-6 flex flex-col items-center">
                    <span className="text-2xl font-bold text-white">{stats.linesAnalyzed || 0}</span>
                    <span className="text-gray-400 mt-2">Lines of Code Analyzed</span>
                  </div>
                  <div className="bg-gray-800 rounded-lg shadow p-6 flex flex-col items-center">
                    <span className="text-2xl font-bold text-white">{stats.languagesUsed || 0}</span>
                    <span className="text-gray-400 mt-2">Languages Used</span>
                  </div>
                  <div className="bg-gray-800 rounded-lg shadow p-6 flex flex-col items-center">
                    <span className="text-2xl font-bold text-white">{stats.accuracyRate || 0}%</span>
                    <span className="text-gray-400 mt-2">Analysis Accuracy</span>
                  </div>
                  <div className="bg-gray-800 rounded-lg shadow p-6 flex flex-col items-center">
                    <span className="text-2xl font-bold text-white">{stats.totalAnalyses || 0}</span>
                    <span className="text-gray-400 mt-2">Total Analyses</span>
                  </div>
                </div>
              </CardContent>
            </Card>
